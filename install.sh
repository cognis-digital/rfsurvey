#!/usr/bin/env sh
# Universal installer for rfsurvey. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/rfsurvey.git"
echo "Installing rfsurvey ..."
