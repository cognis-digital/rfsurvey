"""Native cognis-connect emit for rfsurvey — forward findings to any platform.

Maps rfsurvey's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    rfsurvey ... --format json | rfsurvey-emit --to stix
    rfsurvey-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
